...
const Nav = () => {
    ...
    return (
        <div className='container relative z-20 items-center justify-between px-8 py-5 mx-auto xl:flex'>
            ...
            {/* Mobile Menu */}
            <div
                className={`fixed left-0 top-[3.5rem] w-full bg-white z-10 px-[7px] pb-[4rem] pt-[2rem] xl:hidden max-w-[1024px] transition-all duration-500 ease-in-out overflow-hidden ${
                    menuOpen
